...
export class ApiKeyConfig {
	...
	render() {
		const hasKey = ConfigManager.hasValidApiKey();
                ...
                <div class="api-key-header">
                    ...
                    ${
                        ...
                        <div class="config-notice">
                            ...
                            A default API key is configured. You can override it with your personal key below.
                        </div>
                    `
												: ''
										}
                ...
                <div class="api-key-status ${hasKey ? 'has-key' : 'no-key'}">
                    <div class="status-indicator">
                        ...
                        <span class="status-text">
                            ${hasKey ? `API Key Configured (${keySource === 'user' ? 'Personal' : 'Default'})` : 'No API Key Found'}
                        </span>
                    </div>
                    ${
											hasKey
                        ...
                        <div class="key-preview">
                            Key: ${this.maskApiKey(currentKey)}
                            <span class="key-source">(${keySource === 'user' ? 'Your personal key' : 'Default configuration key'})</span>
                        </div>
                    `
												: ''
										}
                ...
                <div class="api-key-form">
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            value="${keySource === 'user' ? currentKey || '' : ''}"
                        >
